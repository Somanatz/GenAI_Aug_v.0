...
import { LayoutDashboard, Users, BarChart3, Settings, MessageSquare, CalendarDays, FileText } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/parent/reports', label: 'View Reports', icon: FileText },
